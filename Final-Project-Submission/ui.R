...
ui = fluidPage(
  ...
  div(id = "myapp",
      ...
      shinyjs::hidden(
        div(id = "advanced",
            p('- Presentation:', HTML("<a href='https://beta.rstudioconnect.com/englianhu/Final-Project-Submission-Slides/'>Coursera Data Science Capstone - Final Project Submission (Slides)</a>")),
            p('- Author Profile:', HTML("<a href='https://beta.rstudioconnect.com/englianhu/ryo-eng/'>®γσ, Eng Lian Hu</a>")),
            p('- GitHub:', HTML("<a href='https://github.com/englianhu/Coursera-Data-Science-Capstone'>Source Code</a>"))
        )
      ),
      p("Timestamp: ",
        span(id = "time", date()),
